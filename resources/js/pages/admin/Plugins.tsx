...
export default function Plugins({ auth, plugins }: PluginsProps) {
    const handleToggle = async (slug: string, isActive: boolean) => {
        const endpoint = isActive
            ? `/api/cms/plugins/${slug}/deactivate`
            : `/api/cms/plugins/${slug}/activate`;
        ...
        try {
            ...
            alert('An error occurred while toggling the plugin');
        }
    };
                ...
                <div className="flex">
                    <aside className="w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 min-h-[calc(100vh-4rem)]">
                        <nav className="p-4 space-y-1">
                            ...
                            <Link href="/admin/plugins" className="flex items-center px-4 py-2 text-sm font-medium text-gray-900 dark:text-white bg-gray-100 dark:bg-gray-700 rounded-lg">
                    ...
                    <main className="flex-1 p-8">
                        <div className="max-w-7xl mx-auto">
                            <div className="flex items-center justify-between mb-8">
                                <div>
                                    <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Plugins</h2>
                                ...
                                {plugins.map((plugin) => (
                                    ...
                                    >
                                        <div className="flex items-start justify-between">
                                            ...
                                            <div className="ml-6">
                                                <button
                                                    onClick={() => handleToggle(plugin.slug, plugin.is_active)}
                                                    className={`px-4 py-2 font-medium rounded-lg transition-colors ${plugin.is_active
                            ...
                            {plugins.length === 0 && (
                                <div className="text-center py-12 bg-white dark:bg-gray-800 rounded-lg shadow">
                                    ...
                                    <p className="text-gray-600 dark:text-gray-400">No plugins found. Add plugins to the /plugins directory.</p>
                                </div>
                            )}
                        </div>
                    </main>
